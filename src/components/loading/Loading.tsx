...
const Loading = () => {
  ...
  return (
    <section
      className="fixed z-[100] inset-0 backdrop-blur-3xl flex !bg-center !bg-cover flex-col items-center justify-center"
      data-tauri-drag-region>
      <div
        className={`flex items-center w-[16rem] justify-center ${
