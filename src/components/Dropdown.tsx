  ...
  return (
    <span
      ...
      <button
        ...
        className={`flex relative w-full h-10 text-start items-center justify-between ${
          midi ? "!px-2 py-1.5 rounded-lg" : "!px-3 p-1 rounded-lg"
        } text-sm font-normal bg-dark`}>
          ...
          <motion.ul
            ...
            {options.map((item, idx) => (
              <button
                ...
                className={`flex text-start items-center justify-start w-full rounded-lg p-3 text-sm font-normal hover:bg-primary ${
