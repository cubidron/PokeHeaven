...
import { IconMinimize, IconMaximize, IconClose } from "../icons/icons";
...
export function DragRegion(props: { className?: string }) {
  return (
    <span
      ...
      className={`absolute inset-0 w-full h-8 bg-red-500/0 ${props.className}`}></span>
  );
}
// const platform = () => "windows";
export function TitleButtons(props: { className?: string; if?: Platform }) {
